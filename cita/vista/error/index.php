...
<body>
    <div id="error">
        ...
        <div style="text-align: center; margin-top: 40px;">
            <p style="font-family: 'Spicy Rice', cursive; font-size: 50px;">LO SENTIMOS, LA PAGINA A LA QUE DESEA
                ACCEDER
                NO EXISTE</p>
        </div>
        <div  id="fantasma">
            <img id="ima" src="https://img.icons8.com/nolan/526/error.png" alt="..." class="rounded">
        </div>
