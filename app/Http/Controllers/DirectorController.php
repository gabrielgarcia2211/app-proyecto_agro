...
class DirectorController extends Controller
{
    ...
    public function listarEstudiantes()
    {
            ...
            $tipo = $_POST['search'];
            $estudiante = Estudiante::join('users', 'estudiantes.documento', '=', 'users.documento')->join('personas', 'personas.documento', '=', 'users.documento')->where('estudiantes.egresado', '=', $tipo)->get();
